...
//		searchVal.put("infoagree", 0);
		List<Map<String, Object>> note = custDao.custList(searchPrm);
		...
		try {
			...
			for (int rowNum = 1; rowNum <= note.size(); rowNum++) {			
				...
				String custName = getMapValueNullCheck(note.get(rowNum-1), "CUSTNAME");
				String deptName = getMapValueNullCheck(note.get(rowNum-1), "DEPTNAME");
				String duty = getMapValueNullCheck(note.get(rowNum-1), "DUTY");
				String mobile = getMapValueNullCheck(note.get(rowNum-1), "MOBILE");
				String email = getMapValueNullCheck(note.get(rowNum-1), "EMAIL");
				String owner_ = getMapValueNullCheck(note.get(rowNum-1), "OWNER_");
				String custGubun = getMapValueNullCheck(note.get(rowNum-1), "CUSTGUBUN");
				String custGrade = getMapValueNullCheck(note.get(rowNum-1), "CUSTGRADE");
				String infoAgree = getMapValueNullCheck(note.get(rowNum-1), "INFOAGREE");
				String regdate = getMapValueNullCheck(note.get(rowNum-1), "REGDATE");
			...
			String fileDate = fileSearchKey(request);
