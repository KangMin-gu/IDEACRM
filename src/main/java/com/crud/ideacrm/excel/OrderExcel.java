...
public class OrderExcel {
    ...
    public void serviceExcel(HttpServletRequest request, HttpServletResponse response){
        ...
        CellStyle rowColor = wb.createCellStyle();

        XSSFCellStyle head = (XSSFCellStyle) wb.createCellStyle();
        head.setFillForegroundColor(new XSSFColor(new java.awt.Color(185,209, 157)));
        ...
        XSSFCellStyle rowColors = (XSSFCellStyle) wb.createCellStyle();
        rowColors.setFillForegroundColor(new XSSFColor(new java.awt.Color(74,125, 157)));
        rowColors.setFillPattern(HSSFCellStyle.SOLID_FOREGROUND);
        rowColors.setBorderBottom(CellStyle.BORDER_THIN);
        rowColors.setBorderLeft(CellStyle.BORDER_THIN);
        rowColors.setBorderTop(CellStyle.BORDER_THIN);
        rowColors.setBorderRight(CellStyle.BORDER_THIN);
        rowColors.setBorderBottom(CellStyle.BORDER_THIN);
        ...
        columnColor.setBorderBottom(CellStyle.BORDER_THIN);
        columnColor.setBorderLeft(CellStyle.BORDER_THIN);    // 셀 좌측에 얇은 실선 적용.
        columnColor.setBorderRight(CellStyle.BORDER_THIN);    // 셀 우측에 얇은 실선 적용.
        columnColor.setBorderTop(CellStyle.BORDER_THIN);    // 셀 윗쪽에 얇은 실선 적용.
        ...
        try {
            ...
            for (int i = 0; i < order.size(); i++) {
                ...
                if(!orderNum.equals(test)){
                    cell = row.createCell(0);
                    cell.setCellValue(orderNum);
                    cell.setCellStyle(style);
                    cell.setCellStyle(rowColors);
