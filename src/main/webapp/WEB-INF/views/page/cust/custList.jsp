                                ...
                                <div class="table-responsive">
                                    <table style="white-space:nowrap;">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="input-group" style="width:230px;">
                                                    ...
                                                    <input class="form-control form-control-sm daterange searchparam"
                                        ...
                                        <tr>
                                            <th>고객명</th>
                                            <td>
                                                <input class="form-control form-control-sm searchparam" type="text"
                                                       style="width: 150px;" id="custname" name="custname"
                                            ...
                                            <td>
                                                <div class="input-group">
                                                    <input type="text" class="form-control form-control-sm searchparam"
                                                           autocomplete="off" name="cliname">
                                                    <input type="hidden" class="searchparam" name="clino" id="clino"
                                                           value="">
                                            ...
                                            <td>
                                                <div class="input-group">
                                                    <input type="text" class="form-control form-control-sm searchparam"
                                                           autocomplete="off" name="owner_">
                                                    <input type="hidden" class="searchparam" name="owner" id="owner"
                                                           value="">
                                            ...
                                            <td>
                                                <button type="button" class="btn btn-w-m btn-default" id="reset">초기화
                                                </button>
                                            </td>
                                        </tr>
                                        </tbody>
                        ...
                        <div class="ibox-content">
                            ...
                            <form class="deleteForm" action="/cust/del" method="post">
                                <table class="footable table table-striped">
                                    <thead>
                                    <tr>
                                        <th data-name="CUSTNO" data-breakpoints="xs sm"
                                            data-formatter="custListChkBoxFormatter" data-sortable="false"><input
                                                type="checkbox" id="checkAll" onclick="selectCheckbox('custno');"/></th>
                                        <th data-name="CUSTNAME" data-formatter="custListFormatter"
                                            data-filterable="true">고객명
                                        </th>
                                        ...
                                        <th data-name="REGDATE" data-breakpoints="xs sm" data-sorted="true"
                                            data-direction="DESC">등록일
                                        </th>
                                    </tr>
                                    </thead>
                                    <tfoot>
