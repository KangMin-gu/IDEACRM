...
<div id="wrapper">
    ...
    <div id="page-wrapper" class="gray-bg">
            ...
            <div class="col-lg-10">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">
                        <a href="${pageContext.request.contextPath}/">IDEA 공지사항</a>
                    </li>
                    <li class="breadcrumb-item">
                        <strong>IDEA 공지사항 등록</strong>
                    </li>
                </ol>
            </div>
            <div class="col-lg-2">
        ...
        <form:form id="multiFile" action="/notice/input" enctype="multipart/form-data" method="post">
