                ...
                <div class="col-lg-9 animated fadeInRight">
                    <div class="mail-box-header">
                        ...
                        <div class="mail-tools tooltip-demo m-t-md">
                            ...
                            <button class="btn btn-white btn-sm"><i class="fa fa-refresh"></i> 새로고침</button>
                    ...
                    <div class="mail-box">
                        ...
                        <table class="table table-hover table-mail">
                            ...
                            <tr class="unread">
                                ...
                                <td class="mail-ontact">
                                    <a href="mail_detail.html">Jack Nowak</a> <span class="label label-danger float-right">공지</span>
                                </td>
                                <td class="mail-subject">
