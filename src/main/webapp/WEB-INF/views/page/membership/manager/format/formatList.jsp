                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <select class="form-control" style="width:100px;">
                                                    <option value="Bahamas">사용</option>
                                                    <option value="Bahrain">미사용</option>
                                                </select>
                                            </td>
                                            <th>발송매체</th>
                                            <td>
                                                <select class="form-control" style="width:100px;">
                                                    <option value="Bahamas">SMS</option>
                                                    <option value="Bahrain">LMS</option>
                                                    <option value="Bangladesh">EMAIL</option>
                                                    <option value="Barbados">KAKAO</option>
                                                    <option value="Belarus">VOC</option>
                                                </select>
                                            </td>
                                            <td>
                    ...
                    <div class="ibox ">
                        ...
                        <div class="ibox-title">
                            ...
                            <div class="ibox-tools">
                                <a href="/company/format/1">디테일화면</a>
                                <a href="/company/formatform">입력화면</a>
                            </div>
                        </div>
