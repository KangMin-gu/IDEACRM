...
<body>
<c:set var="menuactive" value='mysiteM'/>
<div id="wrapper">
    ...
    <div id="page-wrapper" class="gray-bg">
            ...
            <div class="col-lg-10">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">
                        <a href="${pageContext.request.contextPath}/mysite/${siteInfo.SITEID}">내 회사정보</a>
                    </li>
                    <li class="breadcrumb-item">
                        <strong>내 회사정보수정</strong>
                    </li>
                </ol>
            </div>
        </div>
        ...
        <div class="wrapper wrapper-content animated fadeInRight">
            <form:form id="logoFile" action="/mysite//modified/${siteInfo.SITEID}" method="POST" enctype="multipart/form-data">
            <div class="row">
                <div class="col-lg-12">
                    <button type="submit" class="btn btn-default pull-left">저장</button>
                    <a href="/mysite/${siteInfo.SITEID}" class="btn btn-default pull-right">취소</a>
                </div>
            </div>
