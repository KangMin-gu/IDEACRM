...
<body>
<c:set var="menuactive" value='noticeM'/>
<div id="wrapper">
    ...
    <div id="page-wrapper" class="gray-bg">
        ...
        <form:form id="multiFile" action="/company/notice/modified/${noticeInfo.NTNUM}" enctype="multipart/form-data" method="post">
        <div class="wrapper wrapper-content animated fadeInRight">
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <a href="${pageContext.request.contextPath}/company/notice/${noticeInfo.NTNUM}" class="btn btn-default pull-right">취소</a>
                </div>
            </div>
