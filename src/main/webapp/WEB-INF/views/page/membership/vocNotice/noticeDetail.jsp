...
<div id="wrapper">
    ...
    <div id="page-wrapper" class="gray-bg">
        ...
        <div class="wrapper wrapper-content animated fadeInRight">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <a href="${pageContext.request.contextPath}/voc/notice" class="btn btn-default pull-left">목록</a>
                    <c:if test="${CHKAUTH eq 20}">
                        <a href="${pageContext.request.contextPath}/voc/notice/del/${notice.NTNUM}" class="btn btn-default pull-right" style="margin-left: 5px;">삭제</a>
                        <a href="${pageContext.request.contextPath}/voc/notice/modified/${notice.NTNUM}" class="btn btn-default pull-right">수정</a>
                    </c:if>
                </div>
            </div>
