                                ...
                                <div class="table-responsive">
                                    <table style="white-space:nowrap;">
                                        ...
                                        <tr>
                                            ...
                                            <th>서비스명</th>
                                            <td colspan="3">
                                                <input class="form-control form-control-sm" type="text" style="width: 450px;">
                                            </td>
                                            <th>거래처명</th>
                                            <td>
                                                <input class="form-control form-control-sm" type="text" style="width: 150px;">
                    ...
                    <div class="ibox ">
                        ...
                        <div class="ibox-title">
                            ...
                            <div class="ibox-tools">
                                <a href="/service/delivery/delivery/detail">디테일화면</a>
                                <a href="/service/delivery/delivery/insert">입력화면</a>
                                <a href="/service/delivery/delivery/detail">담당자팝업테스트</a>
                            </div>
                        </div>
