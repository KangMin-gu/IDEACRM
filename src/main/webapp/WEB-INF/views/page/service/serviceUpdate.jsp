                                            ...
                                            <table class="table table-bordered" style="white-space:nowrap;">
                                                ...
                                                <tobdy>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="input-group" style="width:230px;">
                                                                ...
                                                                <input class="form-control form-control-sm date " autocomplete="off" name="visitdate" id="visitdate" type="text"  value="${rewardInfo.VISITDATE_}" />
                                                            </div>
                                                        </td>
                                                        <th>방문예약시간</th>
                                                        <td>
                                                        ...
                                                        <td>
                                                            <div class="input-group" style="width:200px;">
                                                                ...
                                                                <input type="hidden" name="rewardowner" id="rewardowner" class="" value="${serviceInfo.OWNER}">
                                                                <span class="input-group-addon">
                                                                    <a><i class="fa fa-search"></i></a>
                                                                </span>
                                                            </div>
                                                    ...
                                                    <tr>
                                                        <th>지연사유</th>
                                                        <td colspan="9">
                                                            <textarea id="delaydesc" name="delaydesc" class="form-control " style="resize: none;" rows="4">${rewardInfo.DELAYDESC}</textarea>
                                                        </td>
                                                    </tr>
                                                </tobdy>
                                            </table>
