        ...
        <div class="ibox-left col-6">
            ...
            <div class="ibox-content row border-top-0 pt-lg-0 tooltip-demo">
                <div class="table-responsive">
                    <table class="table table-bordered table-hover cti-callback-list" style="border-top: 1px solid #EBEBEB;">
                        <colgroup>
                            <col style="width: 3%;">
                            <col style="width: 15%;">
                            <col style="width: 7%;">
                        ...
                        <thead>
                        <tr>
                            <th><input type="checkbox" class="i-checks icheckAll"></th>
                            <th>접수일자</th>
                            <th>발신번호</th>
                            <th>콜백번호</th>
                        </tr>
            ...
            <div class="ibox-content row border-top-0 pt-lg-0 tooltip-demo">
                <div class="table-responsive">
                    <table class="table table-bordered table-hover">
                        ...
                        <thead>
                        <tr>
                            <th><input type="checkbox" class="i-checks" id="icheckAll"></th>
                            <th>사용자명</th>
                            <th>사용자ID</th>
                            <th>할당된 콜백수</th>
                        </tr>
